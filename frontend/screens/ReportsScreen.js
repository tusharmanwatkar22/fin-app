...
const getStyles = (theme) => StyleSheet.create({
  ...
  header: { fontSize: 26, fontWeight: '800', color: theme.text, marginTop: 60, marginBottom: 24, textAlign: 'center' },
  
  formCard: { 
    backgroundColor: theme.surface, padding: 24, borderRadius: 24, marginBottom: 20,
    shadowColor: theme.cardShadow, shadowOpacity: 0.1, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 6, 
    borderWidth: 1, borderColor: theme.border
  },
  
  headerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8, gap: 10 },
  title: { fontSize: 20, fontWeight: '700', color: theme.text },
  subtext: { fontSize: 14, color: theme.textSecondary, marginBottom: 20, lineHeight: 20 },
